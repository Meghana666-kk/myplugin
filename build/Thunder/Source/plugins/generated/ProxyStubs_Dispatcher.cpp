...
//   - class PluginHost::IDispatcher
//   - class PluginHost::IDispatcher::ICallback
//
...
namespace ProxyStubs {
    ...
    //
    // PluginHost::IDispatcher interface stub definitions
    //
    // Methods:
    //  (0) virtual Core::hresult Validate(const string&, const string&, const string&) const = 0
    //  (1) virtual Core::hresult Invoke(PluginHost::IDispatcher::ICallback*, const uint32_t, const uint32_t, const string&, const string&, const string&, string&) = 0
    //  (2) virtual Core::hresult Revoke(PluginHost::IDispatcher::ICallback*) = 0
    //  (3) virtual PluginHost::ILocalDispatcher* Local() = 0
    //

    ProxyStub::MethodHandler PluginHostDispatcherStubMethods[] = {
        // (0) virtual Core::hresult Validate(const string&, const string&, const string&) const = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            const PluginHost::IDispatcher* implementation = reinterpret_cast<const PluginHost::IDispatcher*>(message->Parameters().Implementation());
        ...
        //
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            PluginHost::IDispatcher* implementation = reinterpret_cast<PluginHost::IDispatcher*>(message->Parameters().Implementation());
            ASSERT(implementation != nullptr);
            ...
            PluginHost::IDispatcher::ICallback* _callback = nullptr;
    ...
    }; // PluginHostDispatcherStubMethods

    //
    // PluginHost::IDispatcher::ICallback interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler PluginHostDispatcherCallbackStubMethods[] = {
        // (0) virtual Core::hresult Event(const string&, const string&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            PluginHost::IDispatcher::ICallback* implementation = reinterpret_cast<PluginHost::IDispatcher::ICallback*>(message->Parameters().Implementation());
            ASSERT(implementation != nullptr);
    ...
    }; // PluginHostDispatcherCallbackStubMethods
    ...
    //
    // PluginHost::IDispatcher interface proxy definitions
    //
    // Methods:
    //  (0) virtual Core::hresult Validate(const string&, const string&, const string&) const = 0
    //  (1) virtual Core::hresult Invoke(PluginHost::IDispatcher::ICallback*, const uint32_t, const uint32_t, const string&, const string&, const string&, string&) = 0
    ...
    class PluginHostDispatcherProxy final : public ProxyStub::UnknownProxyType<PluginHost::IDispatcher> {
    public:
        PluginHostDispatcherProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
        ...
        Core::hresult Invoke(PluginHost::IDispatcher::ICallback* _callback, const uint32_t _channelId, const uint32_t _id, const string& _token, const string& _method, const string& _parameters, string& _response) override
        {
        ...
        Core::hresult Revoke(PluginHost::IDispatcher::ICallback* _callback) override
        {
    ...
    }; // class PluginHostDispatcherProxy

    //
    // PluginHost::IDispatcher::ICallback interface proxy definitions
    //
    // Methods:
    //  (0) virtual Core::hresult Event(const string&, const string&) = 0
    //  (1) virtual Core::hresult Error(const uint32_t, const uint32_t, const uint32_t, const string&) = 0
    ...
    class PluginHostDispatcherCallbackProxy final : public ProxyStub::UnknownProxyType<PluginHost::IDispatcher::ICallback> {
    public:
        PluginHostDispatcherCallbackProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class PluginHostDispatcherCallbackProxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<PluginHost::IDispatcher, PluginHostDispatcherStubMethods> PluginHostDispatcherStub;
        typedef ProxyStub::UnknownStubType<PluginHost::IDispatcher::ICallback, PluginHostDispatcherCallbackStubMethods> PluginHostDispatcherCallbackStub;

        static class Instantiation {
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<PluginHost::IDispatcher, PluginHostDispatcherProxy, PluginHostDispatcherStub>();
                RPC::Administrator::Instance().Announce<PluginHost::IDispatcher::ICallback, PluginHostDispatcherCallbackProxy, PluginHostDispatcherCallbackStub>();
            }
            ~Instantiation()
            {
                RPC::Administrator::Instance().Recall<PluginHost::IDispatcher>();
                RPC::Administrator::Instance().Recall<PluginHost::IDispatcher::ICallback>();
            }

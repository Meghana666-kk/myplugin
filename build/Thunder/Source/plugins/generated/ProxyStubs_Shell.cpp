...
namespace ProxyStubs {
    ...
    //  (18) virtual PluginHost::IShell::startup Startup() const = 0
    //  (19) virtual Core::hresult Startup(const PluginHost::IShell::startup) = 0
    ...
    //  (28) virtual PluginHost::ISubSystem* SubSystems() = 0
    //  (29) virtual void Notify(const string&) = 0
    //  (30) virtual void Register(PluginHost::IPlugin::INotification*) = 0
    //  (31) virtual void Unregister(PluginHost::IPlugin::INotification*) = 0
    //  (32) virtual PluginHost::IShell::state State() const = 0
    //  (33) virtual void* QueryInterfaceByCallsign(const uint32_t, const string&) = 0
    //  (34) virtual Core::hresult Activate(const PluginHost::IShell::reason) = 0
    //  (35) virtual Core::hresult Deactivate(const PluginHost::IShell::reason) = 0
    //  (36) virtual Core::hresult Unavailable(const PluginHost::IShell::reason) = 0
    ...
    ProxyStub::MethodHandler PluginHostShellStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            PluginHost::IShell::startup result = implementation->Startup();

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<PluginHost::IShell::startup>(result);
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const PluginHost::IShell::startup _value = reader.Number<PluginHost::IShell::startup>();
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const PluginHost::IShell::reason _parameter_d3378c37 = reader.Number<PluginHost::IShell::reason>();

            Core::hresult result = implementation->Activate(_parameter_d3378c37);
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const PluginHost::IShell::reason _parameter_d837c1e6 = reader.Number<PluginHost::IShell::reason>();

            Core::hresult result = implementation->Deactivate(_parameter_d837c1e6);
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const PluginHost::IShell::reason _parameter_9d6b6100 = reader.Number<PluginHost::IShell::reason>();

            Core::hresult result = implementation->Unavailable(_parameter_9d6b6100);
    ...
    public:
        ...
        PluginHost::IShell::startup Startup() const override
        {
            ...
            UnknownProxyType::Invoke(message);
            RPC::Data::Frame::Reader reader(message->Response().Reader());
            result = reader.Number<PluginHost::IShell::startup>();

            return (result);
        }

        Core::hresult Startup(const PluginHost::IShell::startup _value) override
        {
            IPCMessage message(BaseClass::Message(19));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<PluginHost::IShell::startup>(_value);
        ...
        Core::hresult Activate(const PluginHost::IShell::reason _parameter_d3378c37) override
        {
            IPCMessage message(BaseClass::Message(34));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<PluginHost::IShell::reason>(_parameter_d3378c37);
        ...
        Core::hresult Deactivate(const PluginHost::IShell::reason _parameter_d837c1e6) override
        {
            IPCMessage message(BaseClass::Message(35));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<PluginHost::IShell::reason>(_parameter_d837c1e6);
        ...
        Core::hresult Unavailable(const PluginHost::IShell::reason _parameter_9d6b6100) override
        {
            IPCMessage message(BaseClass::Message(36));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<PluginHost::IShell::reason>(_parameter_9d6b6100);
